            ...
            <div class="col-lg-12" >
                ...
                <div class="col-lg-12">
                    <div class="col-lg-4 col-lg-offset-2">
                        ...
                        <br />
                        <ul class="list-inline">
                             <li><button id="btnOptionalReport" class="btn btn-primary pull-left"><i class="fa fa-user"></i>  Standard Report</button></li>
                            <li><button id="btnDoReport" class="btn btn-danger pull-left"><i class="fa fa-book"></i>  Optional Report</button></li>
